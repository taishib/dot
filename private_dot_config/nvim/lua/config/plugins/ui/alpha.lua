...
local buttons = {
  ...
  val = {
    ...
    button("n", "Notes", ":Neotree ~/notes<CR>", { icon = "", hl = { { "Float", 1, 2 }, { "Normal", 3, 52 } } }),
    button("m", "PKG Manager", ":Lazy<CR>", { icon = "󰏗", hl = { { "Constant", 1, 2 }, { "Normal", 3, 52 } } }),
    button(
      "c",
      "Config",
      ":Neotree ~/.config/nvim/lua<CR>",
